...
if (isset($_POST['updatepassword']) && $_POST['new_password'] == $_POST['confirm_new_password']) {
    // $id = $_[''];
    
    // $expenseamount = $_POST['expenseamount'];
    $change_password = $_POST['new_password'];
    $sql = "UPDATE users SET password='$change_password' WHERE user_id='$userid'";
...
// else
// {
//     echo '<script> alert("Data incorrect"); 
