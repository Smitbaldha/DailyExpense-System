                    ...
                    <div class="col-md-10">
                        <table class="table table-hover table-bordered">
                            ...
                            <?php $count=1; while ($row = mysqli_fetch_array($exp_fetched)) { ?>
                                <tr>
                                    <td>
                                        <a href="add_expense.php?edit=<?php echo $row['expense_id']; ?>" style="border-radius:0%;"><?php echo $count;?></a>
                                    </td>
                                    <td><?php $date = $row['expensedate'];
                                        $expansedate = date('d-m-Y',strtotime($date));
                                        echo  $expansedate; ?></td>
                                    <td><?php echo $row['expanse_description']; ?></td>
